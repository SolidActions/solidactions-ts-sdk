...
The complete UTF-8 inline request body limit, `inline_batch_max_bytes`, is 5 MiB (5,242,880 bytes). Oversized calls fail locally with `inline_batch_too_large` before network I/O.
