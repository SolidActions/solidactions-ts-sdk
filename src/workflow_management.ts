...
import { SolidActionsSerializer, safeParse, safeParseError } from './serialization';
...
export function toWorkflowStatus(internal: WorkflowStatusInternal, serializer: SolidActionsSerializer): WorkflowStatus {
  return {
